namespace D3.Tests.Core.Search.EFCore.Query.Handlers
{
    ...
    public class EFCoreQueryConfigHandlerTests
        : IClassFixture<EFCoreQueryConfigHandlerFixture>
    {
        public EFCoreQueryConfigHandlerTests(EFCoreQueryConfigHandlerFixture fixture)
        {
